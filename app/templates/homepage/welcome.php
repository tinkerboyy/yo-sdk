...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
        ...
        <link rel="stylesheet" href="hp-assets/css/normalize.css">
	<link rel="stylesheet" href="hp-assets/css/font-awesome.css">
        <link rel="stylesheet" href="hp-assets/css/ag-main.css">
		
		<link rel="stylesheet" type="text/css" href="hp-assets/css/login.css">
	
		<!-- FONTS -->
		<link rel="stylesheet" type="text/css" href="hp-assets/fonts/DINCondensedBold/dincondensedbold.css">
		
        <script src="hp-assets/js/modernizr-2.js"></script>
...
<div id="tabCont"><div  class=" proximaBold" id="action-tab"><a onclick="tabclick(5)" href="/login-information">Sign In</a></div>
	<div  class=" proximaBold" id="info-tab"><a onclick="tabclick(7)" href="/unauth-contact"><span class="fa fa-info-circle"></span></a></div>
</div>
       <div style="opacity: 1;" id="main" class="collapsfix relative">
	   
       <nav class="pagination">
	   
<ul class="ul-nostyle">
<li><a style="" onclick="tabclick(1)" href="#video"><span class="navSelect"></span></a></li>
<li><a style="" onclick="tabclick(2)" href="#whatisactasone"><span class=""></span></a></li>
<li><a style="" onclick="tabclick(3)" href="#whynow"><span class=""></span></a></li>
<li><a style="" onclick="tabclick(4)" href="#ourambition"><span class=""></span></a></li>
</ul>
        ...
        <header id="video" class="scrolling">
               <div class="logo"></div>
               <div style="height: 361px;" class="video relative">
           			<div style="height: 361px;" id="youtube" class="relative">
                    <div class="close absolute"><a href="#"></a></div>
                    </div>
                   <div class="description centerAbsolute">
                       <h1 class="DINCondensedBold antialiased">ACTING AS ONE</h1>
                       <h2 class="proximaLite antialiased">for smarter acquisition</h2>
                       <a href="//youtu.be/QtRIU_o01xk" class="play clearfix DINCondensedBold relative" onclick="_gaq.push(['_trackEvent', ‘viewvideo’, ‘clickthelink’, ‘visitorhasclicked’ ]); return false;"><span class="cta floatL">See the power of Acting as One</span><span class="playIco floatL"></span></a>
           ...
           <div class="scroll1 proximaBold collapsfix">
               ...
               <h4 class="scrollText">What does "Acting as One" mean?</h4>
                  <div class="next">
		<a href="#whatisactasone"  onclick="_gaq.push(['_trackEvent', ‘whatisactone’, ‘clickthelink’, ‘visitorhasclicked’ ]); return false;"></a></div>

         </div>
           
           <div id="01" class="number proximaBold"><div>1</div></div>
           
           <section id="whatisactasone" class="collapsfix scrolling mainWidth sectionPadding">
               <h1 style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="proximaLite apear">What is Act as One?</h1>
               <div class="clearfix">
                   <div style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="cul apear floatL">
                       <figure class="img01"></figure>
                       <h2 class=""><strong class="learn">Learn<br>
                   	   from  experts.</strong></h2>
                    
                   </div>
                   <div style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="cul apear floatL">
                       <figure class="img02"></figure>
                       <h2 class=""><strong class="connect">Connect<br> with those who do it best.</strong></h2>
                    
                   </div>
                   <div style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="cul apear floatL">
                       <figure class="img03"></figure>
                       <h2 class=""><strong class="act">Act<br> with deliberate purpose.</strong></h2>
            ...
            <div class="scroll proximaBold collapsfix">
               <div class="next"><a href="#whynow" onclick="_gaq.push(['_trackEvent', ‘whynow’, ‘clickthelink’, ‘visitorhasclicked’ ]); return false;"></a></div>
           </div>
           <div class="number proximaBold"><div>2</div></div>
           
           <section id="whynow" class="collapsfix scrolling mainWidth sectionPadding">
           	<h1 style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="proximaLite apear">What's in it for me?<br>
               </h1>
               <div class="clearfix">
                   <div style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="cul apear floatL">
                       <figure class="img01"></figure>
                       <h2 class="proximaBold"> Solution Transparency					   </h2>
                       <div class="line"></div>
					   <blockquote>“My greatest asset is knowledge of the contract vehicles in my category.”</blockquote>
					   <p class="credit">Program Manager, CDC</p>
                   
                   </div>
                   <div style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="cul apear floatL">
                       <figure class="img02"></figure>
                       <h2 class="proximaBold">Prices Paid Data</h2>
					   <div class="line"></div>
					   <blockquote>“I like the invoice data.  I can see pricing details about the solutions I use most often.”</blockquote>
					   <p class="credit">Program Manager, GSA</p>
                     </div>
                   <div style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="cul apear floatL">
                       <figure class="img03"></figure>
                       <h2 class="proximaBold">Curated Expertise</h2>
					   <div class="line"></div>
					   <blockquote>“Contracting for me is about learning a new industry every few hours. That’s market research FOR REAL!”</blockquote>
					   <p class="credit">Contracting Officer, VA</p>
           ...
           <div class="scroll proximaBold collapsfix">
               <div class="next"><a href="#ourambition" onclick="_gaq.push(['_trackEvent', ‘ourambition’, ‘clickthelink’, ‘visitorhasclicked’ ]); return false;"></a></div>
           </div>
            <div class="number center proximaBold"><div>3</div></div>
           
           <section id="ourambition" class="scrolling clearfix ">
		   
		   
               <h1 style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="proximaLite apear ">The vision of the Acquisition Gateway is simple, <br>
			   to help you work smarter, faster, and better.</h1>
			   <div class="line"></div>
		       <h2 style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="proximaLite apear">The approach is equally simple &mdash; <br>
<strong class="learn">LEARN</strong>, <strong class="connect">CONNECT</strong>, and <strong class="act">ACT</strong> <br>
with a cross-gov community of experts.</h2>
<div class="line"></div>
<h3 style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="proximaLite apear">Join us!</h3>
<p style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);" class="proximaLite apear">Become an expert or share your expertise.  <br>
	Discover what’s next!</p>


<!--FOOTER LOGIN BUTTON -->

<a onclick="tabclick(6)"  href="/login-information"  class="enter clearfix DINCondensedBold relative"><span class="cta ">ENTER NOW</span></a>
...
<script src="hp-assets/js/jquery.js"></script>
	<noscript>
	</noscript>
    <script>window.jQuery || document.write('<script src="js/vendor/jquery-1.9.1.min.js"></script>')</script>
	<noscript>
	</noscript>
    <script src="hp-assets/js/plugins.js"></script>
	<noscript>
	</noscript>
    <script src="hp-assets/js/ag-main.js"></script>
	<noscript>
	</noscript>
...
<script>
 ...
 if (obj==1) {
  _gaq.push(["_trackEvent", "video", "clickthelink", "visitorhasclicked" ]);
 }

 if (obj==2) {
   _gaq.push(["_trackEvent", "whatisactone", "clickthelink", "visitorhasclicked"]);
 }

 if (obj==3) {
    _gaq.push(["_trackEvent", "whynow", "clickthelink", "visitorhasclicked" ]);
 }
 
 if (obj==4) {
   _gaq.push(["_trackEvent", "ourambition", "clickthelink", "visitorhasclicked" ]);

 }

 if (obj==5) {
   _gaq.push(['_trackEvent', "signin", "clickthelink", "visitorhasclicked" ]);
 }

 if (obj==6) {
   _gaq.push(['_trackEvent', "enternow", "clickthelink", "visitorhasclicked" ]);
 }

 if (obj==7) {
   _gaq.push(['_trackEvent', "unauthcontactus", "clickthelink", "visitorhasclicked" ]);
 }
...
/*
 * v0.1 121011 : First Test Version * v1.0 121012 : Added Cookie Synchronizing and filtered out Outbound tracking of cross- and sub-domain links
