/* configuration for setting up services */
...
module.exports = generators.NamedBase.extend({
  ...
  writing: function() {
    ...
    this.fs.copyTpl(
      this.templatePath('ng-services.js'),
      this.destinationPath(this.config.get('applicationName') + '/ag-app/app/scripts/services/' +  folderName + '/' + fileName + '-' +'module' + '.js'),
      {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(this.config.get('applicationName') + '/ag-app/app/scripts/services/' +  folderName + '/' + fileName + '.html'),
      {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(this.config.get('applicationName') + '/ag-app/app/scripts/services/' +  folderName + '/' + fileName + '.less'),
      {
     ...
     this.fs.copyTpl(
      ...
      this.destinationPath(this.config.get('applicationName') + '/ag-app/app/scripts/services/' + folderName + '/tests/' + fileName + '_test.js'),
      {
        featureName: _.kebabCase(this.name),
        appName: this.config.get('appName'),
        controller: _.upperFirst(_.camelCase(this.name)) + 'Controller',
